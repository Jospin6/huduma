          ...
          Row(
            children: [
              ...
              Image.network(
                ...
                height: 50,
                fit: BoxFit
                    .cover, // Ajout d'un fit pour une meilleure présentation
                ...
                children: [
                  Text(
                    ...
                    style: const TextStyle(
                      color: Colors
                          .white, // Changer la couleur pour plus de contraste
                      fontSize:
                          16, // Augmenter la taille pour une meilleure visibilité
                      fontWeight:
                          FontWeight.bold, // Mettre en gras pour le titre
                    ),
                  ),
          ...
          Padding(
            ...
            child: _isExpanded
                ? Text(
                    ...
                    style: const TextStyle(
                        fontSize: 14,
                        color: Colors.white), // Style pour la description
                  )
